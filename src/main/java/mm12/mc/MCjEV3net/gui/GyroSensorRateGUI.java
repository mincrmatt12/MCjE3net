...
public class GyroSensorRateGUI extends GuiContainer {
	TEGyroSensorRate te;
    public GyroSensorRateGUI (InventoryPlayer inventoryPlayer, TEGyroSensorRate tileEntity) {
            //the container is instanciated and passed to the superclass for handling
            super(new GyroSensorRateContainer(inventoryPlayer, tileEntity));
            te = tileEntity;
    }
