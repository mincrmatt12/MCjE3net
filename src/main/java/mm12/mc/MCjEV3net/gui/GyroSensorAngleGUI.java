...
public class GyroSensorAngleGUI extends GuiContainer {
	TEGyroSensorAngle te;
    public GyroSensorAngleGUI (InventoryPlayer inventoryPlayer, TEGyroSensorAngle tileEntity) {
            //the container is instanciated and passed to the superclass for handling
            super(new GyroSensorAngleContainer(inventoryPlayer, tileEntity));
            te = tileEntity;
    }
