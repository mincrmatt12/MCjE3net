...
public class GenInterfaceGUI extends GuiContainer {
	TEGenInterface te;
    public GenInterfaceGUI (InventoryPlayer inventoryPlayer, TEGenInterface tileEntity) {
            //the container is instanciated and passed to the superclass for handling
            super(new GenInterfaceContainer(inventoryPlayer, tileEntity));
            te = tileEntity;
    }
