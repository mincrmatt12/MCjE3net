...
public class TouchSensorGUI extends GuiContainer {
	TETouchSensor te;
    public TouchSensorGUI (InventoryPlayer inventoryPlayer, TETouchSensor tileEntity) {
            //the container is instanciated and passed to the superclass for handling
            super(new TouchSensorContainer(inventoryPlayer, tileEntity));
            te = tileEntity;
    }
