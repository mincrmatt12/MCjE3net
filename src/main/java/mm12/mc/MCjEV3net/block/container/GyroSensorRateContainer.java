...
public class GyroSensorRateContainer extends Container{

    protected TEGyroSensorRate tileEntity;

    public GyroSensorRateContainer (InventoryPlayer inventoryPlayer, TEGyroSensorRate te){
            tileEntity = te;
