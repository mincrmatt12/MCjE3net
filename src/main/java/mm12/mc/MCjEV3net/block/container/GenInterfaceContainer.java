...
public class GenInterfaceContainer extends Container{

	    protected TEGenInterface tileEntity;

	    public GenInterfaceContainer (InventoryPlayer inventoryPlayer, TEGenInterface te){
	            tileEntity = te;
