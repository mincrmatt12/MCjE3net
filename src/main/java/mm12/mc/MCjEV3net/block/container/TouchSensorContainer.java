...
public class TouchSensorContainer extends Container{

    protected TETouchSensor tileEntity;

    public TouchSensorContainer (InventoryPlayer inventoryPlayer, TETouchSensor te){
            tileEntity = te;
