...
public class GyroSensorAngleContainer extends Container{

    protected TEGyroSensorAngle tileEntity;

    public GyroSensorAngleContainer (InventoryPlayer inventoryPlayer, TEGyroSensorAngle te){
            tileEntity = te;
